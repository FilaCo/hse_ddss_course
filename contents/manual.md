...
Несмотря на это удобство, разработчик распределённой программной системы всегда должен держать в голове 3 важных
...
Должны быть предусмотрены разумные способы решения возникающих при _росте_ (в смысле объёмов данных, трафика или
